...
$_LANG['cappay']      = '首信易支付';
$_LANG['cappay_desc'] = '首信易支付作為具有國家資質認證、政府投資背景的中立第三方網上支付平台擁有雄厚的實力和卓越的信譽。同時，它也是國內唯一首家通過 ISO 9001：2000質量管理體系認證的支付平台。規範的流程及優異的服務品質為首信易支付於2005 和2006年連續兩年贏得「電子支付用戶信任獎」和2006年度「B2B支付創新獎」殊榮奠定了堅實的基礎。<a href="http://localhost/payment_apply.php?mod=cappay" target="_blank"><strong>點擊這裡立即註冊首信易</strong></a>';
