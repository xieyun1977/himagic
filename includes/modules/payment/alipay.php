...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center"><input type="button" onclick="location.href=\'https://mapi.alipay.com/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\'" value="' .$GLOBALS['_LANG']['pay_button']. '" /></div>';
