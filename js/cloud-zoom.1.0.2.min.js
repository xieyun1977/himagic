...
(function($) {
	...
	function CloudZoom(g, i) {
		...
		this.init = function() {
			$('.cloud-zoom-loading', g.parent()).remove();
			n = g.parent().append(format("<div class='mousetrap' style='background-image:url(\".\");z-index:999;position:absolute;width:235px;height:237px;left:%2px;top:%3px;\'></div>", j.outerWidth(), j.outerHeight(), 0, 0)).find(':last');
			...
			n.bind('mouseenter', this, function(a) {
				...
				m = e.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:260px;top:-20px;width:300px;height:230px;background-image:url(\'%4\');z-index:99;"></div>', b, yPos, w, h, s.src)).find(':last');
				if (j.attr('title') && i.showTitle) {
					m.append(format('<div class="cloud-zoom-title" style="display:none;C"></div>', j.attr('title'))).find(':last').css('opacity', i.titleOpacity)
				}
